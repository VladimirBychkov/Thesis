...
variable helps to discriminate throughgoing cosmic muons which passed all previous cuts,
...
quantile bondaries are shown in figure \ref{fig:hadE_Quant}. Since detector configuration was different for 
...
{Three order of magnintude more cosmic events for lower end of number of backwards projected cells comes from cosmic 
...
neutrino oscillations and the tuning of selection criteria is done to maximize experiment sensitivity. However,
