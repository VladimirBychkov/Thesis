...
\begin{figure}[!th]
\centering
\includegraphics[width=1.0\textwidth]{figures/Prediction_systs_contours.pdf}
...
Figure \ref{fig:cant_w_wo_syst} illustrates 90\% confedence levels of 5 samples fit with and without systematics effects 
included. 
