...
\begin{figure}[!th]
\centering
\includegraphics[width=1.0\textwidth]{figures/CorrelationMatrix.pdf}
...
\begin{figure}[!th]
\centering
\includegraphics[width=1.0\textwidth]{figures/reco_resol_BDT_vs_trueE_Full.pdf}
...
\begin{figure}[!th]
\centering
\includegraphics[width=1.0\textwidth]{figures/reco_resol_BDT_vs_recoE_Full.pdf}
